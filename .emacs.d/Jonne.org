...
** Delete trailing whitespace and append a newline
   ...
   We don't want to do this when the file is under version control, so
   the following predicate checks this:
   ...
   #+BEGIN_SRC emacs-lisp
     (add-hook 'find-file-hook '(lambda ()
                                  (when (jms/file-under-version-control-p)
   ...
   #+BEGIN_SRC emacs-lisp
     (add-hook 'before-save-hook '(lambda ()
                                    (unless (jms/file-under-version-control-p)
...
** Dump Jump
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package dumb-jump
       :ensure t
       :bind (("C-M-." . dump-jump-go-other-window)
              ("M-." . dumb-jump-go)
              ("M-," . dumb-jump-back)
