...
** Latex
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     Containins pairs (NAME . (MACRO . IMACRO)) where NAME is a mnemonic for use with `jms/TeX-insert-macro` and MACRO and IMACRO are names of the \"stand-alone\" and inline versions of the todo macro.
     ...
     (defun jms/TeX-insert-todo (category &optional inline)
       "Insert a \"todo\" macro. "
       (interactive
        (let ((categories '("todo" "new" "ref" "clarify" "unsure" "rewrite" "style")))
   ...
   #+BEGIN_SRC emacs-lisp
     (defun org-insert-src-block (src-code-type)
       ...
       (progn
         ...
         (previous-line 2)
         (org-edit-src-code)))
     (bind-key "C-c s i" 'org-insert-src-block org-mode-map)
   #+END_SRC
** Yaml
